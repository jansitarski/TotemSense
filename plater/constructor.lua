...
envTable.FearDatabase = {
  ...
  [21350] = { spells = {{id=22884, name="Psychic Scream", type="fear"}}, instance="Gruul's Lair", npc="Gronn-Priest" },
  ...
  [21218] = { spells = {{id=38946, name="Frightening Shout", type="fear"}}, instance="Serpentshrine Cavern", npc="Vashj'ir Honor Guard" },
  [22056] = { spells = {{id=38154, name="Panic", type="fear"}}, instance="Serpentshrine Cavern", npc="Coilfang Strider" },
  [18805] = { spells = {{id=22884, name="Psychic Scream", type="fear"}}, instance="Tempest Keep", npc="High Astromancer Solarian" },
  ...
  [20060] = { spells = {{id=39427, name="Bellowing Roar", type="fear"}}, instance="Tempest Keep", npc="Lord Sanguinar" },
  ...
  [22855] = { spells = {{id=41150, name="Fear", type="fear"}}, instance="Black Temple", npc="Illidari Nightlord" },
  [23576] = { spells = {{id=42398, name="Frightening Roar", type="fear"}}, instance="Zul'Aman", npc="Nalorakk" },
  [24246] = { spells = {{id=43590, name="Psychic Wail", type="fear"}}, instance="Zul'Aman", npc="Darkheart" },
}
